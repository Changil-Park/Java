...
public class Gamemain {
	...
	public void useplayerSkill(int money2) {
		...
		if (personskillkey.equals("q") && playerlevel >= 1) {
			if (jobmp < 10) {
				...
				sound.playSound("sound/effectsound/energyball", 5.0f, false);
			...
			if (jobmp < 10) {
				...
				sound.playSound("sound/effectsound/flameclaw", 5.0f, false);
				playerskillAttack(damage);
			}
			...
			if (jobmp < 5) {
				...
				sound.playSound("sound/effectsound/magicmirror", 5.0f, false);
				if (damage == 0) {
					mirrorsuccess = 0;
					JOptionPane.showMessageDialog(null,
			...
			if (jobmp < 5) {
				...
				sound.playSound("sound/effectsound/drainHp", 5.0f, false);
				if (damage == 0) {
					hpsuccess = 0;
					JOptionPane.showMessageDialog(null,
			...
			if (jobmp < 100) {
				...
				sound.playSound("sound/effectsound/xcaliber", 5.0f, false);
				playerskillAttack(damage);
			}
		} else {
		...
		if (jobname.equals("warrior")) {
			...
			if (warriorkey.equals("a") && warriorlevel >= 1) {
				if (jobmp < 10) {
					...
					sound.playSound("sound/effectsound/argonslash", 5.0f, false);
					playerskillAttack(damage);
				}
				...
				if (jobmp < 10) {
					...
					sound.playSound("sound/effectsound/hydroslash", 5.0f, false);
					playerskillAttack(damage);
				}
				...
				if (jobmp < 10) {
					...
					sound.playSound("sound/effectsound/leaftornado", 5.0f, false);
					jobhp = jobhp + damage;
					playerskillAttack(damage);
			...
			if (archerkey.equals("a") && archerlevel >= 1) {
				if (jobmp < 10) {
					...
					sound.playSound("sound/effectsound/bombshoot", 6.0f, false);
					playerskillAttack(damage);
				}
				...
				if (jobmp < 10) {
					...
					sound.playSound("sound/effectsound/coldslit", 5.0f, false);
					playerskillAttack(damage);
				}
				...
				if (jobmp < 10) {
					...
					sound.playSound("sound/effectsound/sharpeyes", 5.0f, false);
					playerskillAttack(damage);
			...
			if (wizardkey.equals("a") && wizardlevel >= 1) {
				if (jobmp < 15) {
					...
					sound.playSound("sound/effectsound/firedemon", 6.0f, false);
					playerskillAttack(damage);
				}
				...
				if (jobmp < 15) {
					...
					sound.playSound("sound/effectsound/wateringhole", 6.0f, false);
					playerskillAttack(damage);
				}
				...
				if (jobmp < 15) {
					...
					sound.playSound("sound/effectsound/moonforest", 5.0f, false);
					jobhp = jobhp + damage;
					playerskillAttack(damage);
				}
	...
	public void useRedPotion() {
		...
		if (usepotion.equals("1")) {// 레드포션 사용
			if (redpotion <= 0) {
				...
				sound.playSound("sound/effectsound/getpotion", 5.0f, false);
				jobhp = jobhp + 10;
	...
	public void playerskillAttack(int damage) {// 플레이어가 스킬로 공격
		...
		if (monsterhp <= 0) {
			sound.playSound("sound/effectsound/gamewin", 1.0f, false);
	...
	public void playerAttack(int money2) {// 그냥 떄림
		...
		sound.playSound("sound/effectsound/playerattack", 1.0f, false);
		...
		if (money < 0) {
			sound.playSound("sound/effectsound/gameover", 1.0f, false);
	...
	public void monsterAttack(int money2) {// 몬스터가 때림
		...
		sound.playSound("sound/effectsound/monsterattack", 1.0f, false);
