	...
	public void confirmWeapon() {
		if (wearingWeapon == 1) {
			...
			if (selectionresult.equals("1")) {
				cancelWeapon();
				sound.playSound("sound/effectsound/weaponsoff", 1.0f, false);
			...
			if (selectionresult.equals("1")) {
				if (haveWeapon == 1) {
					wearWeapon();
					sound.playSound("sound/effectsound/equipsword", 1.0f, false);
	...
	public void confirmSuit() {
		if (wearingSuit == 1) {
			...
			if (selectionresult.equals("1")) {
				if (haveSuit == 1) {
					wearSuit();
					sound.playSound("sound/effectsound/equiparmor", 2.0f, false);
	...
	public void confirmMagicSuit() {
		...
		if (wearingmagicSuit == 1) {
			...
			if (selectionresult.equals("1")) {
				if (havemagicSuit == 1) {
					wearmagicSuit();
					sound.playSound("sound/effectsound/equiparmor", 1.0f, false);
